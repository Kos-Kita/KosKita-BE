...
// CancelOrderPaymentOrder provides a mock function with given fields: orderId
func (_m *MidtransInterface) CancelOrderPaymentOrder(orderId string) error {
	ret := _m.Called(orderId)

	if len(ret) == 0 {
		panic("no return value specified for CancelOrderPaymentOrder")
	}
...
// NewOrderPaymentOrder provides a mock function with given fields: _a0
func (_m *MidtransInterface) NewOrderPaymentOrder(_a0 order.OrderCore) (*order.OrderCore, error) {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for NewOrderPaymentOrder")
	}

	var r0 *order.OrderCore
	var r1 error
	if rf, ok := ret.Get(0).(func(order.OrderCore) (*order.OrderCore, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(order.OrderCore) *order.OrderCore); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(order.OrderCore) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
