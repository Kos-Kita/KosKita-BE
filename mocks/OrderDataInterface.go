...
// OrderDataInterface is an autogenerated mock type for the OrderDataInterface type
type OrderDataInterface struct {
	mock.Mock
}

// CancelOrder provides a mock function with given fields: userId, orderId, orderCore
func (_m *OrderDataInterface) CancelOrder(userId int, orderId string, orderCore order.OrderCore) error {
...
func (_m *OrderDataInterface) GetOrder(userId uint) (*order.OrderCore, error) {
...
func (_m *OrderDataInterface) GetOrders(userId uint) ([]order.OrderCore, error) {
	ret := _m.Called(userId)
...
func (_m *OrderDataInterface) PostOrder(userId uint, input order.OrderCore) (*order.OrderCore, error) {
...
func (_m *OrderDataInterface) WebhoocksData(webhoocksReq order.OrderCore) error {
...
// NewOrderDataInterface creates a new instance of OrderDataInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewOrderDataInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *OrderDataInterface {
	mock := &OrderDataInterface{}
	mock.Mock.Test(t)
